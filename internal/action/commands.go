			...
			Subcommands: []*cli.Command{
				{
					...
					ArgsUsage:    "[<directory>]",
					Description:  "Display the template in <directory>, or in the store root if <directory> is not specified.",
					Aliases:      []string{"cat"},
					Before:       s.IsInitialized,
				...
				{
					Name:         "edit",
					Usage:        "Edit a secret template.",
					ArgsUsage:    "[<directory>]",
					Description:  "Edit or create a template in <directory>, or in the store root if <directory> is not specified.",
				...
				},
				{
					Name:         "remove",
					Aliases:      []string{"rm"},
					Usage:        "Remove a secret template.",
					ArgsUsage:    "<directory>",
					Description:  "Remove an existing template from <directory>.",
					Before:       s.IsInitialized,
